...
export const SOURCE_RULES = [
  ...
  // ---- response shape ----------------------------------------------------------
  {
    ...
    title: 'Reads content[0] as text — Opus 5.5 responses start with a thinking block, so this is empty/undefined or throws',
  ...
  },
  {
    ...
    title: 'Reads content[0].text — if this is a Claude response, block 0 is now a thinking block',
  ...
  },
  {
    ...
    title: 'Reads a tool_use block by position — a thinking block comes first on Opus 5.5',
  ...
  },
  {
    ...
    title: 'Stream handler special-cases block index 0 — on Opus 5.5 block 0 is a thinking block',
